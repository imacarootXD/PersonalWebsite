...
export function Sidebar() {
  ...
  return (
    <aside
      className="sidebar sticky top-0 z-20 flex h-dvh shrink-0 flex-col overflow-hidden border-r border-[var(--sidebar-border)] bg-[var(--sidebar)] text-[var(--sidebar-fg)] transition-[width] duration-300 ease-[cubic-bezier(0.22,1,0.36,1)]"
    ...
    >
      <div className="flex h-20 items-center gap-3 px-4">
        <button
          type="button"
          className="grid size-11 shrink-0 place-items-center rounded-2xl bg-[var(--accent)] font-semibold text-[var(--accent-fg)]"
